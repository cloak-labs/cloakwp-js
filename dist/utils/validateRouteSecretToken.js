...
exports.validateRouteSecretToken = void 0;
const AUTH_SECRET = process.env.CLOAKWP_AUTH_SECRET;
function validateRouteSecretToken(secret) {
    ...
    if (!AUTH_SECRET) {
        return {
            error: "Access denied: cannot verify access because you haven't set a CLOAKWP_AUTH_SECRET environment variable.",
        };
    }
...
exports.validateRouteSecretToken = validateRouteSecretToken;
