...
export type WPBlockSpacingPresets = "var:preset|spacing|20" | "var:preset|spacing|30" | "var:preset|spacing|40" | "var:preset|spacing|50" | "var:preset|spacing|60" | "var:preset|spacing|70" | "var:preset|spacing|80";
export type WPBlockSpacingValues = `${number}px` | `${number}em` | `${number}rem` | `${number}vh` | `${number}vw` | `${number}%` | `${number}`;
export type WPBlockSpacingObject<TSpacingPresets extends string = WPBlockSpacingPresets> = {
...
export type WPBlockContext<TComponent = any, TBlockData = RestApiBlockData> = BlockContext<TComponent, TBlockData>;
