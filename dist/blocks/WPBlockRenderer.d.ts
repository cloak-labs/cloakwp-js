import { BlockRenderer, type BlockRendererConfig, type ComponentLike } from "@cloakui/block-renderer";
import { type RestApiBlockData } from "./types";
/**
 * A tiny wrapper around the BlockRenderer class from `@cloakui/block-renderer`, simply
 ...
 */
export declare class WPBlockRenderer<TComponent extends ComponentLike = ComponentLike, TRenderOutput = any, TBlockData = RestApiBlockData> extends BlockRenderer<TComponent, TRenderOutput, TBlockData> {
