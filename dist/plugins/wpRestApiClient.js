...
exports.wpRestApiClient = void 0;
const cloakcms_1 = require("cloakcms");
var wpapi = require("@cloakwp/wpapi/fetch");
const wpRestApiClient = (options) => async (incomingConfig) => {
    const optionsAfterPlugins = await (0, cloakcms_1.withPlugins)(options, options.plugins);
...
exports.wpRestApiClient = wpRestApiClient;
